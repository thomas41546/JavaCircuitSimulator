...
public class CirSim extends Frame
  ...
  MouseMotionListener, MouseListener, ItemListener, KeyListener {
	...
	try {
	    ...
	    if (in > 0) {
		try {
		    doc = doc.substring(in+1);
		    URLDecoder ud = new URLDecoder();
		    doc = ud.decode(doc);
		    startCircuitText = doc;
		} catch (Exception e) {
		    System.out.println("can't decode " + doc);
		    e.printStackTrace();
		}
	    }
	...
	passMenu.add(getClassCheckItem("Add Thomas", "ThomasElm"));
